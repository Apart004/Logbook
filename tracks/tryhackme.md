...
-What I did: Configured and initialized a local Linux development environment. Advanced defensive security studies on TryHackMe, analyzing SOC fundamentals, functional responsibilities, and the core operational pillars (People, Processes, Technology).
-Takeaway: A well-configured Linux system combined with clear SOC operational frameworks forms the foundation of efficient threat monitoring and incident response.
